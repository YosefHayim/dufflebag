...
export interface Manifest {
  /** skills-bag version that performed the install. */
  version: string;
  scope: Scope;
...
export const writeManifest = (installDir: string, manifest: Manifest): void =>
  writeJson(manifestPath(installDir), manifest);
