 ...
 * hook JS (`dist/hooks`) and the skill markdown (`skills/`). These helpers
...
/** Absolute path to the installed package root (one level above dist/). */
export function packageRoot(): string {
  // this file compiles to <root>/dist/core/fs-utils.js → root is two dirs up.
